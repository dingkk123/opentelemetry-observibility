...
OPENTELEMETRY_PROTO_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2flogs_2fv1_2flogs_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::logs::v1::LogRecord* Arena::CreateMaybeMessage<::opentelemetry::proto::logs::v1::LogRecord>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::logs::v1::LogsData* Arena::CreateMaybeMessage<::opentelemetry::proto::logs::v1::LogsData>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::logs::v1::ResourceLogs* Arena::CreateMaybeMessage<::opentelemetry::proto::logs::v1::ResourceLogs>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::logs::v1::ScopeLogs* Arena::CreateMaybeMessage<::opentelemetry::proto::logs::v1::ScopeLogs>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace opentelemetry {
namespace proto {
namespace logs {
...
OPENTELEMETRY_PROTO_API bool SeverityNumber_IsValid(int value);
...
OPENTELEMETRY_PROTO_API const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SeverityNumber_descriptor();
template<typename T>
...
OPENTELEMETRY_PROTO_API bool LogRecordFlags_IsValid(int value);
...
OPENTELEMETRY_PROTO_API const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LogRecordFlags_descriptor();
template<typename T>
...
class OPENTELEMETRY_PROTO_API LogsData final :
...
class OPENTELEMETRY_PROTO_API ResourceLogs final :
...
class OPENTELEMETRY_PROTO_API ScopeLogs final :
...
class OPENTELEMETRY_PROTO_API LogRecord final :
