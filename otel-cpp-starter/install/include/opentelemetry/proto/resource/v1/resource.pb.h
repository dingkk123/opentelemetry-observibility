...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_opentelemetry_2fproto_2fresource_2fv1_2fresource_2eproto OPENTELEMETRY_PROTO_API
...
struct OPENTELEMETRY_PROTO_API TableStruct_opentelemetry_2fproto_2fresource_2fv1_2fresource_2eproto {
  static const uint32_t offsets[];
};
OPENTELEMETRY_PROTO_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2fresource_2fv1_2fresource_2eproto;
...
OPENTELEMETRY_PROTO_API extern ResourceDefaultTypeInternal _Resource_default_instance_;
}  // namespace v1
}  // namespace resource
}  // namespace proto
}  // namespace opentelemetry
PROTOBUF_NAMESPACE_OPEN
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::resource::v1::Resource* Arena::CreateMaybeMessage<::opentelemetry::proto::resource::v1::Resource>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace opentelemetry {
namespace proto {
namespace resource {
...
class OPENTELEMETRY_PROTO_API Resource final :
