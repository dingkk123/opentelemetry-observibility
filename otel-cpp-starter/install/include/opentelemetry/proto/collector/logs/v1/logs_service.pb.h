...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_opentelemetry_2fproto_2fcollector_2flogs_2fv1_2flogs_5fservice_2eproto OPENTELEMETRY_PROTO_API
...
struct OPENTELEMETRY_PROTO_API TableStruct_opentelemetry_2fproto_2fcollector_2flogs_2fv1_2flogs_5fservice_2eproto {
  static const uint32_t offsets[];
};
OPENTELEMETRY_PROTO_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2fcollector_2flogs_2fv1_2flogs_5fservice_2eproto;
...
OPENTELEMETRY_PROTO_API extern ExportLogsPartialSuccessDefaultTypeInternal _ExportLogsPartialSuccess_default_instance_;
class ExportLogsServiceRequest;
struct ExportLogsServiceRequestDefaultTypeInternal;
OPENTELEMETRY_PROTO_API extern ExportLogsServiceRequestDefaultTypeInternal _ExportLogsServiceRequest_default_instance_;
class ExportLogsServiceResponse;
struct ExportLogsServiceResponseDefaultTypeInternal;
OPENTELEMETRY_PROTO_API extern ExportLogsServiceResponseDefaultTypeInternal _ExportLogsServiceResponse_default_instance_;
}  // namespace v1
}  // namespace logs
}  // namespace collector
}  // namespace proto
...
PROTOBUF_NAMESPACE_OPEN
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceRequest* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::logs::v1::ExportLogsServiceRequest>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace opentelemetry {
namespace proto {
namespace collector {
...
class OPENTELEMETRY_PROTO_API ExportLogsServiceRequest final :
...
class OPENTELEMETRY_PROTO_API ExportLogsServiceResponse final :
...
class OPENTELEMETRY_PROTO_API ExportLogsPartialSuccess final :
