...
OPENTELEMETRY_PROTO_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2fcollector_2fprofiles_2fv1development_2fprofiles_5fservice_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::profiles::v1development::ExportProfilesPartialSuccess* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::profiles::v1development::ExportProfilesPartialSuccess>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::profiles::v1development::ExportProfilesServiceRequest* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::profiles::v1development::ExportProfilesServiceRequest>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::profiles::v1development::ExportProfilesServiceResponse* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::profiles::v1development::ExportProfilesServiceResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace opentelemetry {
namespace proto {
namespace collector {
...
class OPENTELEMETRY_PROTO_API ExportProfilesServiceRequest final :
...
class OPENTELEMETRY_PROTO_API ExportProfilesServiceResponse final :
...
class OPENTELEMETRY_PROTO_API ExportProfilesPartialSuccess final :
