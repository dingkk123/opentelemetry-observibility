...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_opentelemetry_2fproto_2fcollector_2fmetrics_2fv1_2fmetrics_5fservice_2eproto OPENTELEMETRY_PROTO_API
...
struct OPENTELEMETRY_PROTO_API TableStruct_opentelemetry_2fproto_2fcollector_2fmetrics_2fv1_2fmetrics_5fservice_2eproto {
  static const uint32_t offsets[];
};
OPENTELEMETRY_PROTO_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2fcollector_2fmetrics_2fv1_2fmetrics_5fservice_2eproto;
...
OPENTELEMETRY_PROTO_API extern ExportMetricsPartialSuccessDefaultTypeInternal _ExportMetricsPartialSuccess_default_instance_;
class ExportMetricsServiceRequest;
struct ExportMetricsServiceRequestDefaultTypeInternal;
OPENTELEMETRY_PROTO_API extern ExportMetricsServiceRequestDefaultTypeInternal _ExportMetricsServiceRequest_default_instance_;
class ExportMetricsServiceResponse;
struct ExportMetricsServiceResponseDefaultTypeInternal;
OPENTELEMETRY_PROTO_API extern ExportMetricsServiceResponseDefaultTypeInternal _ExportMetricsServiceResponse_default_instance_;
}  // namespace v1
}  // namespace metrics
}  // namespace collector
}  // namespace proto
...
PROTOBUF_NAMESPACE_OPEN
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::metrics::v1::ExportMetricsPartialSuccess>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceRequest>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::metrics::v1::ExportMetricsServiceResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace opentelemetry {
namespace proto {
namespace collector {
...
class OPENTELEMETRY_PROTO_API ExportMetricsServiceRequest final :
...
class OPENTELEMETRY_PROTO_API ExportMetricsServiceResponse final :
...
class OPENTELEMETRY_PROTO_API ExportMetricsPartialSuccess final :
