...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_opentelemetry_2fproto_2fcollector_2ftrace_2fv1_2ftrace_5fservice_2eproto OPENTELEMETRY_PROTO_API
...
struct OPENTELEMETRY_PROTO_API TableStruct_opentelemetry_2fproto_2fcollector_2ftrace_2fv1_2ftrace_5fservice_2eproto {
  static const uint32_t offsets[];
};
OPENTELEMETRY_PROTO_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2fcollector_2ftrace_2fv1_2ftrace_5fservice_2eproto;
...
OPENTELEMETRY_PROTO_API extern ExportTracePartialSuccessDefaultTypeInternal _ExportTracePartialSuccess_default_instance_;
class ExportTraceServiceRequest;
struct ExportTraceServiceRequestDefaultTypeInternal;
OPENTELEMETRY_PROTO_API extern ExportTraceServiceRequestDefaultTypeInternal _ExportTraceServiceRequest_default_instance_;
class ExportTraceServiceResponse;
struct ExportTraceServiceResponseDefaultTypeInternal;
OPENTELEMETRY_PROTO_API extern ExportTraceServiceResponseDefaultTypeInternal _ExportTraceServiceResponse_default_instance_;
}  // namespace v1
}  // namespace trace
}  // namespace collector
}  // namespace proto
...
PROTOBUF_NAMESPACE_OPEN
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse* Arena::CreateMaybeMessage<::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace opentelemetry {
namespace proto {
namespace collector {
...
class OPENTELEMETRY_PROTO_API ExportTraceServiceRequest final :
...
class OPENTELEMETRY_PROTO_API ExportTraceServiceResponse final :
...
class OPENTELEMETRY_PROTO_API ExportTracePartialSuccess final :
