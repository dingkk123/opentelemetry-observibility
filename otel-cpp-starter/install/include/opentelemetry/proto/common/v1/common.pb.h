...
OPENTELEMETRY_PROTO_API extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::common::v1::AnyValue* Arena::CreateMaybeMessage<::opentelemetry::proto::common::v1::AnyValue>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::common::v1::ArrayValue* Arena::CreateMaybeMessage<::opentelemetry::proto::common::v1::ArrayValue>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::common::v1::EntityRef* Arena::CreateMaybeMessage<::opentelemetry::proto::common::v1::EntityRef>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::common::v1::InstrumentationScope* Arena::CreateMaybeMessage<::opentelemetry::proto::common::v1::InstrumentationScope>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::common::v1::KeyValue* Arena::CreateMaybeMessage<::opentelemetry::proto::common::v1::KeyValue>(Arena*);
template<> OPENTELEMETRY_PROTO_API ::opentelemetry::proto::common::v1::KeyValueList* Arena::CreateMaybeMessage<::opentelemetry::proto::common::v1::KeyValueList>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace opentelemetry {
namespace proto {
namespace common {
...
class OPENTELEMETRY_PROTO_API AnyValue final :
...
class OPENTELEMETRY_PROTO_API ArrayValue final :
...
class OPENTELEMETRY_PROTO_API KeyValueList final :
...
class OPENTELEMETRY_PROTO_API KeyValue final :
...
class OPENTELEMETRY_PROTO_API InstrumentationScope final :
...
class OPENTELEMETRY_PROTO_API EntityRef final :
