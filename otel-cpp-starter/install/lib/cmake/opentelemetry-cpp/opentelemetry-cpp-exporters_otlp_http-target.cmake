...
foreach(_cmake_expected_target IN ITEMS opentelemetry-cpp::otlp_http_client opentelemetry-cpp::otlp_http_exporter opentelemetry-cpp::otlp_http_log_record_exporter opentelemetry-cpp::otlp_http_metric_exporter)
...
set_target_properties(opentelemetry-cpp::otlp_http_client PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "opentelemetry-cpp::sdk;opentelemetry-cpp::ext;\$<LINK_ONLY:opentelemetry-cpp::proto>;\$<LINK_ONLY:>;opentelemetry-cpp::http_client;\$<LINK_ONLY:opentelemetry-cpp::common>"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/opentelemetry-cpp-exporters_otlp_http-target-*.cmake")
...
foreach(_target "opentelemetry-cpp::sdk" "opentelemetry-cpp::ext" "opentelemetry-cpp::proto" "opentelemetry-cpp::http_client" "opentelemetry-cpp::common" "opentelemetry-cpp::otlp_recordable" )
